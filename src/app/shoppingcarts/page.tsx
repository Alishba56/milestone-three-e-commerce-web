            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
                ...
                <div className="bg-gray-100 rounded-md p-4 h-max">
                    ...
                    <div className="mt-6 space-y-3">
                        <Link href="/checkout">                        <button type="button" className="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-gray-800 hover:bg-gray-900 text-white rounded-md">Checkout</button>
                        </Link>
                        <Link href="/">
